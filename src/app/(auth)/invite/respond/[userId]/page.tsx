		...
		<div className="flex flex-col items-center min-h-screen py-6 px-4">
			<div className="max-w-md w-full bg-white shadow-lg rounded-2xl p-6 flex flex-col gap-4 text-center">
				...
				<p className="text-gray-600">
					Scalepadi admin has invited you to join{" "}
					<span className="font-medium">Scalepadi team</span>.
				</p>
				...
				<div className="flex gap-4 justify-center mt-6">
					<Button
						disabled={isPending}
						onClick={() =>
							handleAcceptDecline("accepted", userId as string)
						}
					...
					<Button
						...
						variant={"destructive"}
						onClick={() =>
							handleAcceptDecline("declined", userId as string)
						}
