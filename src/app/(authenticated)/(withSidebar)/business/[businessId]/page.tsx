...
const BusinessId = () => {
  ...
  // This part of yours expect a string, so i just renamed the key (I'll work on it to accept number as well)
          ...
          <div className="top flex flex-col gap-4">
            <div className="w-full flex items-center gap-3">
              ...
              <div className="flex flex-col gap-2">
                <span className="text-[20px] text-[#3E4351] font-semibold">
                  Growth Audit for GreenMart{" "}
                </span>
                <div className="items-center gap-2 flex">
                  <span className="flex items-center gap-[2px] text-sm text-[#878A93]">
                    ...
                    <span className="text-[#121217]">
                      James Peterson <span className="text-[#878A93]">|</span>{" "}
                      tanya.hill@exple.com{" "}
                      <span className="text-[#878A93]">|</span> +2347089645324
                    </span>
                  </span>
                </div>
              </div>
            ...
            <div className="items-center gap-2 flex">
              <span className="flex items-center gap-[2px] text-sm text-[#878A93]">
                ...
                Joined Date:{" "}
                <span className="text-[#121217]">June 25, 2025</span>
              </span>
              <span className="flex items-center gap-[2px] text-sm text-[#878A93]">
              ...
              <div className="w-full p-6 bg-white">
                ...
                <div className="flex items-center justify-between mt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <Select value={rowPerPage} onValueChange={setRowPerPage}>
