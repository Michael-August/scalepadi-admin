    ...
    <div className="bg-[#ffffff] w-full border-r border-[#EDEEF3] px-[18px] py-[30px] flex flex-col gap-14">
      ...
      <div className="flex w-full h-full flex-col items-center justify-between">
            ...
            return (
              <div
                ...
                onClick={() => {
                  ...
                  router.push(route.route); // ✅ navigate
                }}
        ...
        <div className="flex w-full flex-col gap-3">
          ...
          <div onClick={()=>router.push("/inquiries")} className="flex w-full cursor-pointer justify-between bg-[#F5F6F8] items-center rounded-2xl px-4 py-3">
